...
export const ACTIVE_TELEGRAM_ALERT_INVENTORY: TelegramAlertInventoryEntry[] = [
  ...
  { producer: 'ponsShadowOutcomeTracker sustained transitions', category: 'market', classification: 'normal', renderer: 'renderAlphaNotification', buttonGrammar: 'Chart|Token; Copy CA; Track|Mute when supported; no Trade', sharedAlphaNotification: true },
